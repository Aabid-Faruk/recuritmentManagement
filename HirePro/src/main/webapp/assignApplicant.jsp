...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <% List<ApplicantDTO> applicants = (List<ApplicantDTO>) session.getAttribute("viewAllApplicants"); %>
...
<jsp:include page="index.jsp"/>
	...
	<% if (null !=applicants) {%>
			<table class="table bg-info">
				...
				<tr>
					<td><input type="checkbox" name="applicant_Id" value="<%=applicant.getApplicantId()%>">&nbsp<%=applicant.getApplicantId()%></td>
